...
public class ScriptFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.loadDataWithBaseURL("", "<html><body bgcolor=\"#0C4E76\"><font color=\"white\" face=\"Helvetica Neue Light\"><p>Error, could not load. Make sure you have a network connection.</p></body></html>", "text/html; charset=utf-8", "UTF-8", "");
        ...
        ParseConfig.getInBackground(new ConfigCallback() {
            ...
            public void done(ParseConfig config, ParseException e) {
                ...
                webView.loadDataWithBaseURL("", script, "text/html; charset=utf-8", "UTF-8", "");
            }
        });
        ...
        select2012.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadDataWithBaseURL("", script2012, "text/html; charset=utf-8", "UTF-8", "");
        ...
        select2013.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadDataWithBaseURL("", script2013, "text/html; charset=utf-8", "UTF-8", "");
        ...
        select2014.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadDataWithBaseURL("", script2014, "text/html; charset=utf-8", "UTF-8", "");
    ...
    public void onStart() {
        ...
        //config1 = ParseConfig.getCurrentConfig();
                // Get the message from config or fallback to default value
        //script = config1.getString("guestScript", "www.google.com");
