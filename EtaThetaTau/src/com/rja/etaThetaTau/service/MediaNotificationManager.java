...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "com.rja.pause";
    public static final String ACTION_PLAY = "com.rja.play";
    public static final String ACTION_PREV = "com.rja.prev";
    public static final String ACTION_NEXT = "com.rja.next";
    public static final String ACTION_STOP_CASTING = "com.rja.stop_cast";
    ...
    private Notification createNotification() {
        ...
        if (mController != null && mController.getExtras() != null) {
            ...
            if (castName != null) {
                ...
                notificationBuilder.addAction(R.drawable.ic_close_24dp,
