...
import com.rja.etaThetaTau.objects.Playback;
...
//    private ArrayList<MediaSessionCompat.QueueItem> mQueueItems = new ArrayList<>();
    ...
    public void onCreate() {
        ...
        try {
            ...
            mMediaNotificationManager = new MediaNotificationManager(this, ImagesActivity.createIntent(getApplicationContext(), new ArrayList<String>(), 0));
