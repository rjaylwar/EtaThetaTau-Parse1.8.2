...
public class MediaButtonSet {
    ...
    private void enableButtons(PlaybackStateCompat state) {
        ...
        if (enablePlay) {
            mPlayPause.setBackground(ContextCompat.getDrawable(mPlayPause.getContext(), mPlayResId > 0 ? mPlayResId : R.drawable.ic_play_arrow_24dp));
        } else {
            mPlayPause.setBackground(ContextCompat.getDrawable(mPlayPause.getContext(), mPauseResId > 0 ? mPauseResId : R.drawable.ic_pause_24dp));
        }
