 ...
 */
public class BigImagesAdapter extends RecyclerView.Adapter implements OnClickAtIndexListener {

    ArrayList<String> mUrls = new ArrayList<>();
    Context mContext;

    public BigImagesAdapter(Context context) {
        mContext = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ImageViewHolder(LayoutInflater.from(mContext).inflate(R.layout.list_item_flexible_image, parent, false));
    }
